...
os.environ.setdefault(SERVER_STATUS_TYPE.S_SERVER_STATE_DEV_KEY, SERVER_STATUS_TYPE.S_SERVER_STATE_DEV)
def __init_server_state():
    if SERVER_STATUS_TYPE.S_SERVER_STATE_DEV_KEY in os.environ:

        if os.environ.get(SERVER_STATUS_TYPE.S_SERVER_STATE_DEV_KEY) == SERVER_STATUS_TYPE.S_SERVER_STATE_DEV or os.environ.get(SERVER_STATUS_TYPE.S_SERVER_STATE_DEV_KEY) == SERVER_STATUS_TYPE.S_SERVER_STATE_PRODUCTION_1 or os.environ.get(SERVER_STATUS_TYPE.S_SERVER_STATE_DEV_KEY) == SERVER_STATUS_TYPE.S_SERVER_STATE_PRODUCTION_2:
