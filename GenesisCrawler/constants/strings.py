...
# Sitemap
S_DEFAULT_SUBMISSION_RULE_1 = "New Onion Service"
S_DEFAULT_SUBMISSION_RULE_2 = "Update Onion Service"
S_DEFAULT_RULE = "checked"

# Search
S_SEARCH_TYPE_PARAM = "all"
S_SEARCH_CONTENT_TYPE_IMAGE = "images"
S_SEARCH_STOP_WORDS = ['about', 'above', 'across', 'ill', 'after', 'again', 'against', 'all', 'almost', 'alone',
