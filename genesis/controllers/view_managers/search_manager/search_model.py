...
from genesis.controllers.service_manager.elastic_manager.elastic_enums import ELASTIC_REQUEST_COMMANDS, ELASTIC_CRUD_COMMANDS
from genesis.controllers.service_manager.elastic_manager.elastic_controller import elastic_controller
from genesis.controllers.view_managers.search_manager.search_enums import SEARCH_MODEL_COMMANDS, SEARCH_CALLBACK, SEARCH_SESSION_COMMANDS, SEARCH_MODEL_TOKENIZATION_COMMANDS
from genesis.controllers.view_managers.search_manager.search_session_controller import search_session_controller
from genesis.controllers.view_managers.search_manager.spell_checker import spell_checker
...
class search_model(request_handler):
    ...
    def __query_results(self, p_data):
        ...
        m_documents = elastic_controller.get_instance().invoke_trigger(ELASTIC_CRUD_COMMANDS.S_READ, [ELASTIC_REQUEST_COMMANDS.S_SEARCH,[m_query_model],[None]])
        m_parsed_documents = self.__parse_filtered_documents(m_documents)
        ...
        m_context[SEARCH_CALLBACK.M_QUERY_ERROR] = self.__m_spell_checker.spell_check_query(m_query_model.m_search_query)
