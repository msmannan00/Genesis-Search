...
from orion.controllers.constants.strings import GENERAL_STRINGS, SEARCH_STRINGS
from orion.controllers.helper_manager.helper_controller import helper_controller
from orion.controllers.view_managers.user.interactive.search_manager.search_data_model.query_model import query_model
...
class search_session_controller(request_handler):
    ...
    def __init_parameters(self, p_document_list, p_search_model, p_tokenized_query):
        ...
        if p_search_model.m_total_documents >= 40:
