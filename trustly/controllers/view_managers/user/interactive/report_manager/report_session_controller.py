from trustly.controllers.constants.message import REPORT_MESSAGES
...
class report_session_controller(request_handler):
  ...
  def init_callbacks(p_report_model: report_data_model):
    m_context_response = {REPORT_CALLBACK.M_URL: p_report_model.m_url, REPORT_CALLBACK.M_EMAIL: p_report_model.m_email, REPORT_CALLBACK.M_MESSAGE: p_report_model.m_message, REPORT_CALLBACK.M_URL_ERROR: GENERAL_STRINGS.S_GENERAL_EMPTY, REPORT_CALLBACK.M_EMAIL_ERROR: GENERAL_STRINGS.S_GENERAL_EMPTY, REPORT_CALLBACK.M_SECURE_SERVICE_NOTICE: p_report_model.m_site, }
