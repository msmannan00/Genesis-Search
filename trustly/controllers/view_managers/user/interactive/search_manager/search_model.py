...
from trustly.controllers.view_managers.user.interactive.search_manager.search_enums import SEARCH_CALLBACK, SEARCH_SESSION_COMMANDS, SEARCH_MODEL_COMMANDS
...
class search_model(request_handler):
  ...
  @staticmethod
  def __check_hate_query(p_query):
