...
class index_model:
  ...
  def __init__(self, p_base_url_model, p_title, p_meta_description, p_important_content, p_important_content_hidden, p_meta_keywords, p_content, p_content_type, p_sub_url, p_images, p_document, p_video, p_validity_score):
