...
class CONSTANTS:
    ...
    S_SETTINGS_INDEX_STATS_TIMEOUT = 604800
    S_SETTINGS_INDEX_CRAWL_BEAT_TIMEOUT = 60
    S_SETTINGS_MAX_DOCUMENT_SHOWN_LENGTH = 20
    ...
    S_SETTINGS_DIRECTORY_LIST_MAX_SIZE = 10000
