...
from genesis_server.controllers.view_managers.user_views.directory_manager.directory_enums import \
    DIRECTORY_SESSION_COMMANDS, DIRECTORY_MODEL_CALLBACK, DIRECTORY_MODEL_COMMANDS
from genesis_server.controllers.view_managers.user_views.directory_manager.directory_session_controller import \
...
from genesis_shared_directory.service_manager.elastic_manager.elastic_enums import ELASTIC_CRUD_COMMANDS, \
