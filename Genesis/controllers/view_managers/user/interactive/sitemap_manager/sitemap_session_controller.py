...
from Genesis.controllers.constants.message import SITEMAP_MESSAGES, GENERAL_MESSAGES
from Genesis.controllers.constants.strings import GENERAL_STRINGS, SITEMAP_STRINGS
...
from Genesis.controllers.view_managers.user.interactive.sitemap_manager.sitemap_enums import SITEMAP_PARAM, SITEMAP_CALLBACK, SITEMAP_SESSION_COMMANDS
