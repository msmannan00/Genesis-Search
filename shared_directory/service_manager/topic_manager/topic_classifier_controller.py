...
from shared_directory.service_manager.topic_manager.topic_classifier_model import topic_classifier_model
from shared_directory.service_manager.topic_manager.topic_classifier_trainer import topic_classifier_trainer
