...
from modules.user_data_parser.parse_instance.i_crawl_crawler.html_parse_manager import html_parse_manager
from modules.user_data_parser.parse_instance.local_shared_model.index_model import index_model
